...
export default function AdminPortfolio() {
  ...
  const handleGenerate = async () => {
    ...
    try {
      ...
      if (response.ok) {
        setStatus({ type: 'success', message: 'Page Portfolio créée avec succès dans Sanity Studio!' })
        setTimeout(() => {
  ...
  return (
    <Container>
      <Title>Administration - Page Portfolio</Title>
      
      <Card>
        <Description>
          Créez automatiquement la page "Portfolio" dans Sanity Studio avec une galerie 
          de projets, études de cas et statistiques de réalisations.
        </Description>
        ...
        >
          {isGenerating ? 'Génération en cours...' : 'Créer la Page Portfolio dans Studio'}
        </Button>
